				...
				<div class="m-portlet__body">
						<div class="m-portlet__body">
							...
							<div class="form-group m-form__group row">
								<a class="col-form-label btn btn-accent text-white col-lg-2 col-sm-12" href="<?php echo site_url('admin/tambah_halaman')?>">
					                    ...
					                    <tr>
					                    	<td>
					                    		<h6 class="text-truncate mb-0">
							                      <a href="<?php echo site_url('admin/edit_halaman/'.$halaman->id_halaman)?>" class="col-md text-success">
					                    	...
					                    	<td>
							                    	<a href="<?php echo site_url('admin/edit_halaman/'.$halaman->id_halaman)?>"><i class="la la-edit text-d-none"></i> Ubah</a> &nbsp;|&nbsp;
							                    	<a class="text-danger " href="<?php echo site_url('admin/hapus_halaman/'.$halaman->id_halaman)?>"> <i class="la la-trash text-d-none"></i> Hapus</a>&nbsp;|&nbsp;
