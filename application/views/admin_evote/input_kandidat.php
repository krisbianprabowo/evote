<div class="m-grid__item m-grid__item--fluid m-wrapper">
	...
	<div class="m-content">
		<div class="m-portlet">
			...
			<!--begin::Form-->
			<?php echo form_open_multipart('admin/simpan_kandidat', ['class'=>'form-horizontal m-form m-form--fit m-form--label-align-right']) ?>
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<input type="file" class="form-control m-input" id="upload" name="media" placeholder="Enter post title">
						</div>
					</div>
				</div>
